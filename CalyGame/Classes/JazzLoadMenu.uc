...
function DrawSlots(canvas Canvas)
{
	...
	For ( i=0; i<10; i++ )
	{
		//if (i%2 == 0)
		//{
			XPos = Canvas.ClipX*0.5; // ((MenuExistTime-(float(i)*0.5))*500)-1000; // 0.05
			if (XPos>StartX) 
			{
				XPos = StartX;
				if (MenuNumReady<i) 
		...
		{
			XPos = Canvas.ClipX*0.5; // 1000-((MenuExistTime-(float(i)*0.5))*500);
			if (XPos<StartX) 
			{
				XPos = StartX;
				if (MenuNumReady<i) 
...
defaultproperties
{
     SlotNames(0)="Ice Lizard 16:56  10"
     SlotNames(1)="Untitled 17:47  10"
     SlotNames(2)="Untitled 18:08  10"
     SlotNames(3)="Untitled 19:04  14"
     SlotNames(4)="EMPTY SLOT"
     SlotNames(5)="EMPTY SLOT"
     SlotNames(6)="EMPTY SLOT"
     SlotNames(7)="EMPTY SLOT"
     SlotNames(8)="EMPTY SLOT"
