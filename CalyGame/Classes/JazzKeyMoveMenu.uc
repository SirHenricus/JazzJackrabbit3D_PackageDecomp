...
// JazzKeyMoveMenu.
//=============================================================================
class JazzKeyMoveMenu expands JazzMenu;
...
defaultproperties
{
     ...
     MenuList(0)="FORWARD"
     MenuList(1)="BACKWARD"
     MenuList(2)="LOOK LEFT"
     MenuList(3)="LOOK RIGHT"
     MenuList(4)="LOOK UP"
     MenuList(5)="LOOK DOWN"
     MenuList(6)="STRAFE LEFT"
     MenuList(7)="STRAFE RIGHT"
     MenuList(8)="JUMP"
     MenuList(9)="DUCK"
     MenuList(10)="RESET TO DEFAULT"
