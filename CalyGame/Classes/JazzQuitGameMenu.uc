	...
	if (YesNo)
	{
		if (bResponse)
		{
			...
			else
			{
				...
				{
				PlayerOwner.ConsoleCommand("set ini:Engine.Engine.AudioDevice MusicVolume "$100);
...
defaultproperties
{
     ThumbUp=Texture'JazzArt.Interface.ThumbUp'
     ThumbD=Texture'JazzArt.Interface.ThumbD'
     MenuLength=3
     Menutype=8.000000
}
