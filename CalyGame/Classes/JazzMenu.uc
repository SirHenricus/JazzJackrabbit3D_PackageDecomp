...
defaultproperties
{
     ...
     MenuBarTR=Texture'JazzArt.Interface.MenuBarTR'
     MenuBarTL=Texture'JazzArt.Interface.MenuBarTL'
     MenuBarBR=Texture'JazzArt.Interface.MenuBarBR'
     MenuBarBL=Texture'JazzArt.Interface.MenuBarBL'
     MenuBack=Texture'JazzArt.Interface.MenuBack'
     NWater3=Texture'JazzArt.Effects.NWater3'
     MenuTop=Texture'JazzArt.Interface.MenuTop'
     MenuBarTRX=Texture'JazzArt.Interface.MenuBarTRX'
     MenuBarTLX=Texture'JazzArt.Interface.MenuBarTLX'
     MenuBarBRX=Texture'JazzArt.Interface.MenuBarBRX'
     MenuBarBLX=Texture'JazzArt.Interface.MenuBarBLX'
     MenuBckR=Texture'JazzArt.Interface.MenuBckR'
     MenuBck=Texture'JazzArt.Interface.MenuBck'
     changeselection=Sound'JazzSounds.Interface.changeselection'
     menuweird=Sound'JazzSounds.Interface.menuweird'
}
