...
var() localized bool LeftSide; // Patch change - this is, err... no longer used. Sorry about that.
var() localized float Menutype; // Patch change - this is used for the awesome menu transitions!
// 0 - Main view to the ruins
// 1 - Options view to the cogs
// 2 - Multiplayer/Other game modes
// 3 - Save / Load
// 4 - Key settings
// 5 - Exit
