...
defaultproperties
{
     ...
     GameCommandLine="-log"
     EditPackages=("Core","Engine","Editor","Fire","IpDrv","IpServer","JazzSounds","JazzSpeech","JazzArt","JazzSpecial","JazzAnimated","JazzTitle","JazzFonts","JazzObjectoids","JazzDecoration","JWindow","Jazz3","CalyGame","JazzEnemy","JazzPlatform","JazzRace")
     C_WorldBox=(B=107)
     C_GroundPlane=(B=63)
